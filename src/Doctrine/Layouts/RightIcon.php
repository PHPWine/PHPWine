  ...
  public function Position($menu_items, $prefix, $falsy) {
    ...
    foreach ($menu_items as $value => $content) {      
     ...
     $acdn_menu[] = wine(div,
      ...
      .wine(__,[
        child=>[
          please => function() use ($prefix, $valid_hook, $falsy, $content) {

           // Hook for icon item
           $hook_icon_default_top = "top_defualt_".$prefix.$valid_hook;
           $hook_icon_default_bot = "bottom_defualt_".$prefix.$valid_hook;

           $hook_icon_clicked_top = "top_clicked_".$prefix.$valid_hook;
           $hook_icon_clicked_bot = "bottom_clicked_".$prefix.$valid_hook;
          ...
          //  $iconHook = $this->valid_hook($hook_value_content);
           ...
           $iconLeft[] = wine(span,$default,[classes=>$prefix."icon-left d$valid_hook"],[
           ...
           if(function_exists($hook_icon_default_top)) {
            ...
            $iconLeft[] = wine(span,$clicked,[classes=>$prefix."icon-left c$valid_hook"],[
              [$hook_icon_default_top],
              [$hook_icon_clicked_bot]
            ]);
          
           } else if(function_exists($hook_icon_default_bot)) {
          ...
          } else if(function_exists($hook_icon_default_top) || function_exists($hook_icon_default_bot)) {
      ...
      .wine(div,$content,[classes=>"content"],[
        [$hook_content_top],
        [$hook_content_bot]
      ]);
